                                ...
                                <textarea class="form-control" id="message" name="message" rows="7" placeholder="Enter your message.."></textarea>
								 ...
								 <div class="form-group form-actions">
                                                    <div class="col-xs-12 text-right">
                                                        <button class="btn btn-primary waves-effect waves-light m-1" onclick="submitTicket()">Send</button>
                                                    </div>
                                                </div>
								</form>
							</div>
            ...
            <div class="card">
                <div class="card-header block-header-default">
                    ...
                    <div class="card-options">
						  ...
						  <button class="btn btn-info waves-effect waves-light m-1" data-toggle="tooltip" title="Refresh The List" onclick="updateTickets()"><i class="fa fa-refresh"></i></button>
