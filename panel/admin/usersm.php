...
<h3 style="color: white;" class="card-title"><i class="fa fa-users"></i> Total Users</h3>
</div>
<div class="card-body">
<div class="table-responsive">
<table class="table table-bordered table-striped table-vcenter  dataTable no-footer dataTables_wrapper container-fluid dt-bootstrap4"  id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info">
                    <thead>
                                        <tr>
     ...
     while ($getInfo = $getusers -> fetch(PDO::FETCH_ASSOC))
      {
		...
		if($planInfox['vip'] == "1") {
          ...
          $rank = '<span class="badge badge-success">Member</span>';
                                           ...
                                           echo '<tr>
                                            <td class="text-center"><span class="badge">'.$id.'</span></td>
