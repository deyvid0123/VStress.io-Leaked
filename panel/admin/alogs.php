...
<h3 style="color: white;" class="card-title"> Blacklist</h3>
</div>
<div class="card-body">
<div class="table-responsive">
		<table class="table table-borderless table-vcenter js-dataTable-full dataTable no-footer">
						<thead>
								<tr>
							...
							while($getInfo = $SQLGetLogs -> fetch(PDO::FETCH_ASSOC)){
								...
								echo '<tr>
										<td><strong><span class="badge">'.htmlspecialchars($user).'</span></strong></td>
										<td><strong><span class="badge">'.htmlspecialchars($host).$port.'</span></strong> <span class="badge badge-info">('.htmlspecialchars($method).')</span></strong><br></td>
										<td><strong><span class="badge">'.htmlspecialchars($time).'</span></strong></td>
										<td>'.$date.'</td>
										<td><strong><span class="badge ">'.htmlspecialchars($handler).'</span></strong></td>
									  </tr>';
							}
							?>	
							</tbody>                                    
