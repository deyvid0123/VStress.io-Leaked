...
?>
                ...
                <div class="card ">
					...
					<blockquote class="blockquote-reverse">
										...
										<footer><?php echo $username . ' [ ' . $date . ' ]'; ?></footer>
													...
													function ()
													{
													$('#live_servers').load('complexx/tickets/tickets.php?id=<?php echo $_GET['id']; ?>').fadeIn("slow");
													}, 1000);
													</script>
									...
									<form class="form-horizontal push-10-t push-10" action="base_forms_premade.html" method="post" onsubmit="return false;">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 text-center">                                             
												...
												<button class="btn btn-sm btn-light"><a href="inbox.php">
													<i class="zmdi zmdi-sign-in push-5-r"></i> Back to Inbox
												</a></button>
                                            </div>
                                        </div>
                                    </form>
	...
	<script>
			...
			function response(){
				...
				xmlhttp.open("GET","complexx/tickets/tickets.php?id=<?php echo $_GET['id']; ?>",true);
				xmlhttp.send();
			}
			...
			function closeticket(){
				...
				xmlhttp.open("GET","complexx/tickets/closeticket.php?id=<?php echo $_GET['id']; ?>",true);
				xmlhttp.send();
			}
			...
			function message() {
				...
				xmlhttp.open("GET","complexx/tickets/reply.php?id=<?php echo $_GET['id']; ?>" + "&message=" + reply,true);
				xmlhttp.send();
			}
