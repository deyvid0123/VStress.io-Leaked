...
?>
    ...
    <div class="container-fluid">
            <h5 class="content-heading text-center">Terms Of Service</h5>

			This Terms and Conditions Agreement (the "Agreement"), made effective as of the 1st day of October, 2016, applies to all products, services and websites ("Services") offered by vStress.io. ("vStress") or its subsidiaries or affiliated companies. Product and service specific terms and conditions may be posted.</br></br>
...
</br><bb class="text-danger"><strong><center>WE OFFER ONLY ATTACKS TO CHECK THE STRENGTH OF YOUR SERVER/HOSTING, USING ANOTHER IN vStress NOT AT OUR OWN RISK!</center></strong></bb>
</br></br>
            <div class="card">
			<div class="card-body">
			
           <h5 class="text-primary">INTRODUCTION</h5>   
1.1 This Agreement between the end user, You, and vStress consists of the Standard Terms and Conditions for our Services.</br>
1.2 This Agreement is effective as of the 1st day of April, 2015.</br>
1.3 This Agreement may change at any time. vStress will post any changes to this Agreement in advance to the effective date and will provide a more prominent notice, including an email notification, for any significant changes. vStress will maintain an archive containing prior versions of this Agreement for your review. If You do not wish to accept a new version of this Agreement, discontinue use of our Services. 
            </div>
			 </div>
          
		              <div class="card">
					  <div class="card-body">
           <h5 class="font-size-xl text-primary">COPYRIGHT</h5>   
...
2.2 The copying, redistribution, use or publication of any part or parts of our Services is strictly prohibited without the written discretion of vStress.</br>
2.3 You do NOT acquire ownership rights to any content, documents or other materials when viewed through our Services. The posting of information or materials on our Services does not constitute a waiver of any right in such information or materials. Once information or material is posted on our Services, it becomes the property of vStress.
		   </div>
		    </div>
		   
		              <div class="card">
					   <div class="card-body">
           <h5 class="font-size-xl text-primary">INTELLECTUAL PROPERTY</h5>   
3.1 vStress offers various information in downloadable form. Downloading such files does not grant ownership of the information contained within.</br>
3.2 Downloadable files may not be sold or redistributed under any circumstances without the written discretion of vStress.
		   </div></div>
		   
		   		              <div class="card">
							   <div class="card-body">
           <h5 class="font-size-xl text-primary">MEMBERSHIP</h5>   
4.1 vStress offers membership free of charge.</br>
...
4.6 Any account believed to be in violation of the clauses 4.4 or 4.5, above, will be suspended without any prior notice needed and legal process may be filed against the offending party.</br>
		   		   		              ...
		   		   		              <div class="card">
									   <div class="card-body">
           <h5 class="font-size-xl text-primary">REFERRALS</h5>   
5.1 vStress offers rewards for referrals.</br>
...
5.5 Account credit can be used towards future purchases only and cannot be withdrawn.</br>
		   		   		   		              ...
		   		   		   		              <div class="card">
											   <div class="card-body">
           <h5 class="font-size-xl text-primary">ORDERING</h5>   
...
6.4 Chargebacks and other disputes will result in immediate service suspension, if applicable. Service may be permanently terminated depending on the outcome of the chargeback or dispute.
		   		   		   		   		              ...
		   		   		   		   		              <div class="card">
													   <div class="card-body">
           <h5 class="font-size-xl text-primary">SALES TAX</h5>   
7.1 vStress is required by law to charge sales tax for our applicable Services.</br>
...
7.2.3 Any orders placed before we receive the proper tax exemption certificates will be charged applicable sales tax, which cannot be refunded or credited.</br>
		   		   		   		   		   		              ...
		   		   		   		   		   		              <div class="card">
															   <div class="card-body">
           <h5 class="font-size-xl text-primary">PRICING</h5>   
...
8.3 vStress will not honor prices from server errors or from cached pages. If a server error has occurred, any customers affected will be contacted as soon as possible and will be allowed to cancel or edit the affected order. Any resulting refunds will be handled as described in Section 10 Refunds.
		   </div></div>
		   		   		   		   		   		   		   		              ...
		   		   		   		   		   		   		   		              <div class="card">
																			   <div class="card-body">
           <h5 class="font-size-xl text-primary">REFUNDS</h5>   
10.1 Refunds are only granted after the request has been reviewed and approved by vStress.</br>
...
10.4 vStress will only refund to the source from which payment was received. This greatly diminishes the possibility of fraud.</br>
		   </div>
		   </div>
		   
		   		   		   		   		   		   		   		   		              <div class="card">
																					   <div class="card-body">
           <h5 class="font-size-xl text-primary">SERVICE ACCESS</h5>   
...
11.3 vStress may offer reasonable compensation for any unexpected backbone service interruptions for all affected parties in the unlikely event such an interruption shall occur.
		   </div>
		   </div>
		   
		   		   		   		   		   		   		   		   		   		              <div class="card">
																							   <div class="card-body">
           <h5 class="font-size-xl text-primary">BANDWIDTH GUARANTEE</h5>   
...
12.6 Subject to internal investigation before account credit is issued.
		   ...
		   <div class="card">
		    <div class="card-body">
		              <h5 class="font-size-xl text-primary">VISITOR MATERIAL AND CONDUCT</h5>   
...
13.5 If You misuse our Services, including, but not limited to the methods described above, we will fully cooperate with law enforcement authorities and disclose any information to those authorities that will identify and/or locate anyone in breach of clauses 13.1, 13.2, 13.3 and/or 13.4, above.</br>
		   ...
		   <div class="card">
		    <div class="card-body">
		   		              <h5 class="font-size-xl text-primary">LIABLILITY</h5>   
14.1 In no event shall vStress be held liable for any special, incidental or consequential damages or any nature due to the use of our Services and/or any information found with our Services. This includes, but is not limited to, damages resulting in loss of profit or revenue, installation costs, damage to property, personal injury, death and legal expenses.</br>
14.2 You acknowledge that vStress and the manufacturer or supplier of any products or information found on our Services are not to be held responsible for any claim or damage resulting from use.</br>
14.3 Any statements or advice offered or given to You is given without charge. vStress assumes no liability for such statements or advice and the use of such.</br>
14.4 You must agree to indemnify, defend and hold us and our partners, attorneys, staff and affiliates harmless from any liability, loss, claim and expense, including resultant attorney fees, related to your violation of this Agreement and/or use of our Services.
							  		   ...
							  		   <div class="card">
									    <div class="card-body">
		   		              <h5 class="font-size-xl text-primary">DISCLAIMER</h5>   
...
15.3 The material on our Services is provided "as is" without any warranties of any kind.</br>
							  							  		   ...
							  							  		   <div class="card">
																    <div class="card-body">
		   		              <h5 class="font-size-xl text-primary">PRIVACY</h5>   
...
17.1 By agreeing to this Agreement, You acknowledge that You have read and agree to our Acceptable Use Policy, currently v1.0.</br>
							  							  							  		   ...
							  							  							  		   <div class="card">
																							    <div class="card-body">
		   		              <h5 class="font-size-xl text-primary">THIRD PARTY SERVICES</h5>   
18.1 Google, Inc.</br>
...
18.1.2 Google's Terms of Service, http://www.google.com/intl/en/policies/terms/</br>
							  							  							  							  		   ...
							  							  							  							  		   <div class="card">
																														    <div class="card-body">
		   		              <h5 class="font-size-xl text-primary">LINKS TO THIRD PARTY WEBSITES</h5>   
19.1 vStress provides links to third party websites solely for your convenience. If You use any of these links, You are leaving our Services and therefore no longer protected by this Agreement.</br>
19.2 vStress has not reviewed all of the information on linked third party websites. We are not in control of nor do we endorse any information found on these websites.</br>
19.4 If You decide to access any of these third party websites, You do so entirely at your own risk and vStress assumes no liability.</br>
If You have any questions or comments concerning this Agreement, please contact us eith in our live chat or ticket system.
							  							  							  							  							  		   ...
							  							  							  							  							  		   <div class="card">
																																					    <div class="card-body">
		   		              <h5 class="font-size-xl text-primary text-center">OTHER</h5>   
