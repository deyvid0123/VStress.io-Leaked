...
<div class="alert alert-outline-danger alert-dismissible">
			...
			<div class="alert-message">
			  <span><strong>ERROR!</strong> Host is not a valid URL</span>
			</div></div>
				';
die();
				}
...
<div class="alert alert-outline-danger alert-dismissible">
			...
			<div class="alert-message">
			  <span><strong>ERROR!</strong> You are not allowed to attack these websites</span>
			</div></div>
				';
die();
...
if($vip == "1"){
	...
	$vip = 'Normal';
		...
		echo '<div class="alert alert-outline-success alert-dismissible" role="alert">
			...
			<div class="alert-message">
			  <span><strong>SUCCESS!</strong> Attack sent to<br> Host: <font class="text-primary">'.$host.'</font> <br>Time: <font class="text-success">'.$time.'</font> <br>Network: <font class="text-primary">'.$vip.'</font> <br>TotalServers: <font class="text-danger">'.$totalservers.'</font> <br> with server: <font class="text-warning">'.$handlers.'</span>
			</div></div>';
